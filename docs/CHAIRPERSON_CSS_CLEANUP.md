...
5. `manage-instructors.blade.php` - 78 lines removed from `<style>` block
6. `select-curriculum-subjects.blade.php` - 160+ lines removed from `<style>` block
7. `assign-subjects.blade.php` - 90+ lines removed from `<style>` block + 30 lines from `@push('styles')`
8. `structure-template-requests.blade.php` - 15 lines removed from `@push('styles')`
9. `structure-template-create.blade.php` - 40 lines removed from `@push('styles')`
10. `reports/co-course-chooser.blade.php` - 80+ lines removed from `@push('styles')`
