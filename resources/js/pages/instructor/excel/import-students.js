  ...
  if (confirmForm) {
    confirmForm.addEventListener('submit', function (e) {
      ...
      if (!confirmSubjectId || !confirmSubjectId.value) {
        showAlert(
          'Please select a target subject via the "Compare with Subject" dropdown before importing.',
          'warning'
        );
        return;
      }
  ...
  if (importBtn) {
    importBtn.addEventListener('click', function (e) {
      ...
      if (!compareSubject || !compareSubject.value) {
        showAlert(
          'Please select a target subject using the "Compare with Subject" dropdown before importing',
          'warning'
        );
        compareSubject?.focus();
        return;
