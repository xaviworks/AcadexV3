/**
 * Instructor Grade Script JavaScript
 * Handles grade input validation, keyboard navigation, auto-save, and term stepper
 */
...
window.updateCourseOutcomeDropdowns = updateCourseOutcomeDropdowns;
window.initGradeScript = initGradeScript;
