                    ...
                    <form action="{{ route('admin.announcements.update', $announcement) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="all_users" 
                                       {{ $announcement->target_roles === null ? 'checked' : '' }} 
                                       onchange="toggleRoleSelection()">
                                <label class="form-check-label" for="all_users">
                                    All Users
                                </label>
                            </div>
                            <div id="role-selection" class="mt-2" style="display: {{ $announcement->target_roles === null ? 'none' : 'block' }};">
                                @php $targetRoles = old('target_roles', $announcement->target_roles ?? []); @endphp
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="target_roles[]" value="0" id="role_instructor"
                                           {{ in_array(0, $targetRoles) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="target_roles[]" value="1" id="role_chairperson"
                                           {{ in_array(1, $targetRoles) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="target_roles[]" value="2" id="role_dean"
                                           {{ in_array(2, $targetRoles) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="target_roles[]" value="5" id="role_vpaa"
                                           {{ in_array(5, $targetRoles) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="is_dismissible" name="is_dismissible" value="1"
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="show_once" name="show_once" value="1"
                                       {{ old('show_once', $announcement->show_once) ? 'checked' : '' }}>
