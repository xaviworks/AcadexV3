    ...
    <div data-section-container data-initial-section="{{ $initialSection }}">
        <div data-section="overview" class="{{ $overviewActive ? '' : 'd-none' }}">
            ...
            <div class="row g-4 mb-4" id="overview-department-grid">
                @php
                    $defaultBadgeLabel = optional($globalFormula)->label ?? 'Institution Fallback';
                @endphp
        ...
        <div data-section="formulas" class="{{ $formulasActive ? '' : 'd-none' }}">
            ...
            <div class="alert alert-warning d-flex align-items-start gap-2 shadow-sm mb-4" role="alert">
                ...
                <div>
                    <strong>Formula hierarchy:</strong> Subject Override -> Course Override -> Department Baseline -> Institution Fallback.
                    <div class="small mt-1">Use institution fallback formulas only as emergency coverage when no department baseline exists.</div>
                </div>
            </div>
            ...
            @php
                ...
                // Fetch institution fallback formulas from the controller data
            ...
            @if($globalFormulas->isNotEmpty())
                <div class="mb-4">
                    <h4 class="mb-3 fw-semibold text-dark">
                        <i class="bi bi-shield-exclamation me-2"></i>Institution Fallback Formulas
                    </h4>
                    <p class="text-muted small mb-3">Emergency fallback formulas used only when subject, course, and department formulas are unavailable.</p>
                </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-start gap-2">
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="text-muted small mb-2">
                                                <i class="bi bi-shield-exclamation me-1"></i>Institution Fallback · {{ $formula['context_label'] }}
                                            </p>
                                            <span class="badge bg-info-subtle text-info">
                                                <i class="bi bi-life-preserver me-1"></i>Emergency Coverage
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        @else
                                            <span class="badge bg-light text-secondary">
                                                <i class="bi bi-shield-exclamation me-1"></i>Using Institution Fallback: {{ $globalLabel }}
                                            </span>
                                        @endif
                                    </div>
                                </div>
