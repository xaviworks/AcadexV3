        ...
        <div class="col-lg-8">
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">
                        <i class="bi bi-pencil"></i> Edit Tutorial: {{ $tutorial->title }}
                    </h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.tutorials.update', $tutorial) }}" 
                          method="POST" 
                          id="tutorialForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('priority', $tutorial->priority) }}"
                                       min="0">
                                @error('priority')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-check mb-3">
                            <input type="checkbox" 
                                   ...
                                   class="form-check-input"
                                   value="1"
                                   {{ old('has_data_check', $tutorial->dataCheck ? true : false) ? 'checked' : '' }}>
                            <label class="form-check-label" for="has_data_check">
                                Check if page has data before starting tutorial
                            </label>
                        </div>

                        <div id="dataCheckConfig" style="display: {{ old('has_data_check', $tutorial->dataCheck ? true : false) ? 'block' : 'none' }};">
                        ...
                        <div class="mt-4 d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save"></i> Update Tutorial
                            </button>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ url($tutorial->page_identifier) }}" 
                       target="_blank" 
                       class="btn btn-warning btn-sm w-100">
                        <i class="bi bi-box-arrow-up-right"></i> Open Target Page
                    </a>
                </div>
            </div>
        </div>
