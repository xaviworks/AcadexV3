...
<div class="container-fluid px-4 py-5">
    @include('chairperson.partials.reports-header', [
        ...
        'subtitle' => 'Select a program to view Program Learning Outcome attainment in ' . ($department->department_description ?? 'your department'),
        'icon' => 'bi-diagram-3',
        ...
        @forelse($courses as $course)
            <div class="col-md-4">
                <div
                    ...
                    data-url="{{ route('dean.reports.co-program', ['course_id' => $course->id]) }}"
        ...
        @empty
            <div class="col-12">
                <x-empty-state
                    ...
                    message="No programs are available for your department."
                />
            </div>
        @endforelse
    </div>
