...
<div class="container-fluid px-4 py-5">
    ...
    @include('chairperson.partials.reports-header', [
        ...
        'subtitle' => 'Search a student, then choose an enrolled course to view outcome summary',
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
            <form method="GET" action="{{ route('dean.reports.co-student') }}">
        ...
        <div class="mt-4">
            <div class="card border-0 shadow-sm rounded-4 mb-3">
                <div class="card-body px-4 py-3 d-flex flex-wrap justify-content-between align-items-center gap-3">
                    ...
                    <a href="{{ route('dean.reports.co-student', ['student_query' => $studentQuery]) }}" class="btn btn-outline-secondary rounded-pill">
            ...
            <div class="card border-0 shadow-sm rounded-4 enrolled-courses-card">
                <div class="card-body p-4 p-md-5">
                    <h6 class="fw-bold mb-3 d-flex align-items-center">
                        <i class="bi bi-stars text-success me-2"></i>Enrolled Courses
                    </h6>
                    ...
                    @if($enrolledSubjects->isEmpty())
                        <x-empty-state
                            ...
                            message="This student has no enrolled courses in the selected academic period."
                        />
                    @else
                        <div class="row g-3 enrolled-courses-list">
                            @foreach($enrolledSubjects as $subject)
                                <div class="col-12 col-sm-6 col-lg-4">
                                    <a
                                        href="{{ route('dean.reports.co-student', ['student_id' => $selectedStudent->id, 'subject_id' => $subject->id]) }}"
                            ...
                            @foreach($searchedStudents as $stu)
                                <div class="col-md-6">
                                    <div class="border rounded-3 p-3 d-flex justify-content-between align-items-center">
                                        ...
                                        <a
                                            href="{{ route('dean.reports.co-student', ['student_query' => $studentQuery, 'student_id' => $stu->id]) }}"
    ...
    @else
        <div class="mt-4">
            <x-empty-state
                ...
                message="Find a student first, then choose one of their enrolled courses to view the outcome summary."
            />
        </div>
    @endif
</div>
