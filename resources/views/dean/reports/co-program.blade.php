...
<div class="container-fluid px-4 py-5">
    ...
    <div class="card border-0 shadow-sm rounded-4 mt-4">
        <div class="card-body p-4">
            @if(collect($byCourse)->isEmpty())
                <x-empty-state
                    :compact="true"
                    icon="bi-journal-x"
                    title="No Courses Found"
                    message="No courses or assessed Course Outcomes were found for this academic period."
                />
            @else
                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead>
                            <tr class="table-light border-bottom border-2">
                                <th class="text-start ps-3" style="width: 30%;">
                        ...
                        <tbody>
                            @foreach($byCourse as $courseId => $row)
