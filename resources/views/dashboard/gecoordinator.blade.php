...
@section('content')
<div class="container-fluid px-4 py-4" x-data="gecoordinatorDashboard(@js($countInstructors), @js($countStudents), @js($countCourses))" x-init="init()">
            ...
            <div class="card h-100 border-0 shadow-sm rounded-4 hover-lift">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted small mb-0">
                        <i class="bi bi-arrow-right"></i> GE faculty members
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm rounded-4 hover-lift">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted small mb-0">
                        <i class="bi bi-arrow-right"></i> In GE subjects this semester
                    </p>
                </div>
            </div>
        </div>
