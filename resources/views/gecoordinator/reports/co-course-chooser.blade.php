        ...
        @forelse($courses as $c)
            <div class="col-md-4">
                <div class="course-card card h-100 border-0 shadow-lg rounded-4 overflow-hidden" 
                     data-url="{{ route('gecoordinator.reports.co-course') }}?course_id={{ $c->id }}"
...
{{-- Styles: resources/css/gecoordinator/reports.css --}}
{{-- JavaScript: resources/js/pages/gecoordinator/reports/co-course-chooser.js --}}
@endsection
