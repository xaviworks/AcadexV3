    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold text-dark mb-1">
                <i class="bi bi-person-lines-fill text-success me-2"></i>Student Outcomes Summary (GE Courses)
            </h2>
            <p class="text-muted mb-0">Select a GE subject and student to view detailed Course Outcome performance</p>
        </div>
        <div>
