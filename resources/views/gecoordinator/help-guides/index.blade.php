...
<div class="modal fade" id="createGuideModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
        <div class="modal-content border-0 shadow">
            ...
            <form id="createGuideForm" action="{{ route('gecoordinator.help-guides.store') }}" method="POST" enctype="multipart/form-data" data-no-page-loader>
                @csrf
                <div class="modal-body">
                    {{-- Title --}}
                    <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.delete-guide').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            document.getElementById('deleteForm').action = `{{ url('gecoordinator/help-guides') }}/${id}`;
    ...
    document.querySelectorAll('.edit-guide').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            document.getElementById('editGuideForm').action = `{{ url('gecoordinator/help-guides') }}/${id}`;
