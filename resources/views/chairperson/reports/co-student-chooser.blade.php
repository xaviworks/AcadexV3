        ...
        <div class="mt-4">
            <div class="card border-0 shadow-sm rounded-4 mb-3">
                <div class="card-body px-4 py-3 d-flex flex-wrap justify-content-between align-items-center gap-3">
                    ...
                    <a href="{{ route('chairperson.reports.co-student', ['student_query' => $studentQuery]) }}" class="btn btn-outline-secondary rounded-pill">
                        ...
                        <div class="row g-3 enrolled-courses-list">
                            @foreach($enrolledSubjects as $subject)
                                <div class="col-12 col-sm-6 col-lg-4">
                                    <a
                                        href="{{ route('chairperson.reports.co-student', ['student_id' => $selectedStudent->id, 'subject_id' => $subject->id]) }}"
                            ...
                            @foreach($searchedStudents as $stu)
                                <div class="col-md-6">
                                    <div class="border rounded-3 p-3 d-flex justify-content-between align-items-center">
                                        ...
                                        <a
                                            href="{{ route('chairperson.reports.co-student', ['student_query' => $studentQuery, 'student_id' => $stu->id]) }}"
