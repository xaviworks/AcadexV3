 ...
 * Provides the base tutorial manager functionality for GE Coordinator pages
 * 
 * Features:
    ...
    window.GECoordinatorTutorial = {
        ...
        getCurrentPageId: function() {
            ...
            if (path.includes('/gecoordinator/grades')) {
                ...
                if (urlParams.get('course_id')) {
                    return 'gecoordinator-grades-instructors';
                }
            ...
            if (path.includes('/gecoordinator/instructors')) {
                ...
                if (hash === '#inactive' || document.querySelector('#inactive-instructors-tab.active')) {
                    return 'gecoordinator-instructors-inactive';
                }
                if (hash === '#pending' || document.querySelector('#pending-approvals-tab.active')) {
                    return 'gecoordinator-instructors-pending';
                }
                if (hash === '#ge-requests' || document.querySelector('#ge-requests-tab.active')) {
                    return 'gecoordinator-instructors-ge-requests';
                }
                return 'gecoordinator-instructors';
            }
            
            // Dashboard - check for dashboard path or root with role detection
            if (path === '/dashboard' || path === '/' || path.includes('/gecoordinator/dashboard')) {
                // Check if we're on the GE Coordinator dashboard by looking for GE-specific elements
                const gecTitle = document.querySelector('h2.fw-bold');
                if (gecTitle && (gecTitle.textContent.includes('GE Coordinator') || gecTitle.textContent.includes('General Education'))) {
