/**
 * Dean Tutorial System - Core Manager
 * Provides the base tutorial manager functionality for Dean pages
 * 
 * Features:
...
(function() {
    ...
    window.DeanTutorial = {
        ...
        STORAGE_PREFIX: 'acadex_dean_tutorial_',
        ...
        getCurrentPageId: function() {
            ...
            // Reports - Student CO
            if (path.includes('/dean/reports/co-student')) {
                if (urlParams.get('student_id')) {
                    return 'dean-reports-co-student-detail';
                }
                return 'dean-reports-co-student';
            }
            
            // Reports - Course CO
            if (path.includes('/dean/reports/co-course')) {
                if (urlParams.get('course_id')) {
                    return 'dean-reports-co-course-detail';
                }
                return 'dean-reports-co-course';
            }
            
            // Reports - Program CO
            if (path.includes('/dean/reports/co-program')) {
                return 'dean-reports-co-program';
            }
            
            // Grades - Multi-step wizard
            if (path.includes('/dean/grades')) {
                if (urlParams.get('subject_id')) {
                    return 'dean-grades-students';
                }
                if (urlParams.get('instructor_id')) {
                    return 'dean-grades-subjects';
                }
                if (urlParams.get('course_id')) {
                    return 'dean-grades-instructors';
                }
                return 'dean-grades';
            }
            
            // Instructors
            if (path.includes('/dean/instructors')) {
                return 'dean-instructors';
            }
            
            // Students
            if (path.includes('/dean/students')) {
                return 'dean-students';
            }
            
            // Dashboard - check for dashboard path or root with role detection
            if (path === '/dashboard' || path === '/') {
                // Check if we're on the dean dashboard by looking for dean-specific elements
                const deanTitle = document.querySelector('h2.fw-bold');
                if (deanTitle && deanTitle.textContent.includes('Dean')) {
        ...
        showNoDataStep: function(step) {
            ...
            if (!targetEl) {
                targetEl = this.findTarget('table thead, .card-header, .container-fluid h1, h1');
            }
        ...
        resetAllProgress: function() {
            ...
            console.log('Dean Tutorial progress reset');
        },
        ...
        resetProgress: function(tutorialId) {
            ...
            console.log('Dean Tutorial progress reset for:', tutorialId);
        }
    };
})();
